...
public sealed class DbSeeder : IHostedService
{
    ...
    private static async Task SeedDemoDataAsync(AppDbContext db, CancellationToken ct)
    {
        ...
        // ── 4. Loads ─────────────────────────────────────────────────────────
        var ld1041 = new Load { Lane = laneChiDal, ReferenceNumber = "LD-1041", PickupDate = today.AddHours(8).AddMinutes(14),  DeliveryDate = today.AddDays(1), TargetRate = 2600m, BookedRate = 2600m, Status = "Accepted",  IsAutoBooked = true,  CreatedAt = today.AddHours(8).AddMinutes(14) };
        var ld1042 = new Load { Lane = laneMemAtl, ReferenceNumber = "LD-1042", PickupDate = today.AddHours(8).AddMinutes(21),  DeliveryDate = today.AddDays(1), TargetRate = 2300m, BookedRate = 2300m, Status = "Accepted",  IsAutoBooked = true,  CreatedAt = today.AddHours(8).AddMinutes(21) };
        var ld1043 = new Load { Lane = laneDalPhx, ReferenceNumber = "LD-1043", PickupDate = today.AddHours(8).AddMinutes(33),  DeliveryDate = today.AddDays(2), TargetRate = 2550m, BookedRate = null,   Status = "Pending",   IsAutoBooked = false, CreatedAt = today.AddHours(8).AddMinutes(33) };
        var ld1044 = new Load { Lane = laneAtlClt, ReferenceNumber = "LD-1044", PickupDate = today.AddHours(8).AddMinutes(45),  DeliveryDate = today.AddDays(1), TargetRate = 2100m, BookedRate = 2100m, Status = "Accepted",  IsAutoBooked = true,  CreatedAt = today.AddHours(8).AddMinutes(45) };
        var ld1045 = new Load { Lane = laneLarHou, ReferenceNumber = "LD-1045", PickupDate = today.AddHours(8).AddMinutes(58),  DeliveryDate = today.AddDays(1), TargetRate = 2200m, BookedRate = null,   Status = "Rejected",  IsAutoBooked = false, CreatedAt = today.AddHours(8).AddMinutes(58) };
        var ld1046 = new Load { Lane = laneChiDal, ReferenceNumber = "LD-1046", PickupDate = today.AddHours(9).AddMinutes(2),   DeliveryDate = today.AddDays(1), TargetRate = 2600m, BookedRate = null,   Status = "Pending",   IsAutoBooked = false, CreatedAt = today.AddHours(9).AddMinutes(2) };
        var ld1047 = new Load { Lane = laneHouMia, ReferenceNumber = "LD-1047", PickupDate = today.AddHours(9).AddMinutes(11),  DeliveryDate = today.AddDays(2), TargetRate = 3800m, BookedRate = null,   Status = "Pending",   IsAutoBooked = false, CreatedAt = today.AddHours(9).AddMinutes(11) };
        var ld1048 = new Load { Lane = laneMemAtl, ReferenceNumber = "LD-1048", PickupDate = today.AddHours(9).AddMinutes(19),  DeliveryDate = today.AddDays(1), TargetRate = 2250m, BookedRate = null,   Status = "Pending",   IsAutoBooked = false, CreatedAt = today.AddHours(9).AddMinutes(19) };
